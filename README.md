...
| LLM | Qwen3.8 27B (FP4) via Ollama, local | Sin costo, sin rate limits, sin internet. Los documentos ISO nunca salen de la maquina. Elegido midiendo, no por ser el mas nuevo -- ver *Comparar modelos* |
...
La presentacion del proyecto (13 laminas) esta en [`docs/presentacion.html`](docs/presentacion.html)
-- abrela en el navegador y navega con las flechas o deslizando -- y en
[`docs/NormIA.pptx`](docs/NormIA.pptx). El guion para exponerla, con las preguntas
probables y sus respuestas, esta en [`docs/guion-exposicion.md`](docs/guion-exposicion.md).
...
# 27.8B parametros, 256K de contexto, cuantizacion FP4 (nvfp4). El campo
# `architecture` dice qwen3_5: es la familia de arquitectura, no la version.
ollama serve &
